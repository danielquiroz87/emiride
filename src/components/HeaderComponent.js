...
<nav className={`navbar header_ navbar-expand-lg navbar-light ${isOpen ? 'navbar-open' : ''}`}>
  <div className={"container-fluid"}>
    ...
    <div className={"d-flex justify-content-end align-items-center"}>
      <a aria-label="Spanish" className={`nav-link header-text mx-2 ${isOpen ? 'hide-language-icon' : ''}`} href="https://emiride.com/inicio"><img src={spainImage} width="30" height="30" alt="Spanish Version"/></a>
    </div>
