...
function FormComponentMobile(){
    ...
    return(
        <form className="hide-on-desktop show-on-tablet-mobile-flex" id="mobile-booking-form"  onSubmit={handleSubmit} style={{height:620}}>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="form-group">
                        <label htmlFor="mobile-pick-up-place">Lugar de recogida<span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="mobile-drop-off-place">Lugar de devolución<span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="mobile-startDate">Fecha de recogida<span className="red-color">*</span></label>
                        <input id="mobile-startDate" className="form-control" type="date"
                                              value={date_from}
                                              onChange={(e) => setDate_from(e.target.value)} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="mobile-endDate">Fecha de devolución<span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="mobile-pick-up-hour">Hora de recogida<span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="mobile-drop-off-hour">Hora de devolución <span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="mobile-age">Edad (Años)</label>
            ...
            <div className="container py-4">
                <div className="row align-items-center justify-content-center">
                    <div className="col text-center">
                        <button type="submit" id="mobile-submitBtnMobile" className="btn btn-lg btn-secondary rounded-pill submit-button ">Reserva</button>
                    </div>
                </div>
            </div>
        </div>
