...
function FormComponent(){
    ...
    return(
        ...
        <div className="container">
            <h3 className="py-3 form-tittle">RESERVA TU VEHÍCULO</h3>
            <div className="row">
                <div className="col-6">
                    <div className="form-group">
                        <label htmlFor="pick-up-place">Lugar de recogida <span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="startDate">Fecha de recogida<span className="red-color">*</span></label>
                    ...
                    <div className="row">
                        <div className="form-group col-6">
                            <label htmlFor="pick-up-hour">Hora de recogida <span className="red-color">*</span></label>
                        ...
                        <div className="form-group col-6">
                            <label htmlFor="pick-up-minute">Minuto de recogida</label>
                ...
                <div className="col-6">
                    <div className="form-group">
                        <label htmlFor="drop-off-place">Lugar de devolución <span className="red-color">*</span></label>
                    ...
                    <div className="form-group">
                        <label htmlFor="endDate">Fecha de devolución <span className="red-color">*</span></label>
                    ...
                    <div className="row">
                        <div className="form-group col-6">
                            <label htmlFor="drop-off-hour">Hora de devolución<span className="red-color">*</span></label>
                        ...
                        <div className="form-group col-6">
                            <label htmlFor="drop-off-minute">Minuto de devolución</label>
            ...
            <div className="container py-4">
                <div className="row align-items-center justify-content-center">
                    <div className="col text-center">
                        <button type="submit" id="submitBtn" className="btn btn-lg btn-secondary rounded-pill submit-button ">Reserva</button>
                    </div>
                </div>
            </div>
        </div>
